...
%TODO: Add a description of pseudo-fields.
...
explicitly before the initializer for \chpl{d} is encountered.  A
...
\end{chapel}
\noindent
means, ``initialize \chpl{a} to \chpl{2}, \chpl{c} to \chpl{_c}, \chpl{b} to \chpl{3}
...
the receiver and passing no arguments.\footnote{The \chpl{_defaultOf()} feature
