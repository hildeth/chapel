...
This section describes the syntax and semantics for the \chpl{noinit}
initializer.
...
with \sntx{initializer-expression} in those contexts and define the latter as:
\begin{syntax}
...
%TODO: Is this description current?
...
%TODO: Refine this into a proposal.
